...
description: >-
  Ecosystem evolution manager. Audits Claude Code configuration (agents, scripts,
  hooks, skills, settings, MCP) against latest release. Keeps global config aligned.
