...
description: Chief of Staff — receives problems, routes to 69 agents across 10 domains, orchestrates multi-domain execution with domain-specific validation.
