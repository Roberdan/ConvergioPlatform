...
# Source shared libraries (save SCRIPT_DIR — common.sh overrides it to lib/)
_SYNC_SCRIPT_DIR="$SCRIPT_DIR"
source "${_SYNC_SCRIPT_DIR}/lib/common.sh"
source "${_SYNC_SCRIPT_DIR}/lib/peers.sh"
source "${_SYNC_SCRIPT_DIR}/lib/sync-dashboard-db-ops.sh"
source "${_SYNC_SCRIPT_DIR}/lib/sync-dashboard-db-multi.sh"
SCRIPT_DIR="$_SYNC_SCRIPT_DIR"
