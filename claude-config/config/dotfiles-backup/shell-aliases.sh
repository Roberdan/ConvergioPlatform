...
# === Buongiorno (morning routine) — sourced from separate file ===
_ALIASES_DIR="${BASH_SOURCE[0]%/*}"
# shellcheck source=shell-buongiorno.sh
[[ -f "${_ALIASES_DIR}/shell-buongiorno.sh" ]] && source "${_ALIASES_DIR}/shell-buongiorno.sh"
