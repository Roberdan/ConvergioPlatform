...
| Phase      | Engine                | Why                                         |
| ---------- | --------------------- | ------------------------------------------- |
| Planning   | Claude (claude-opus-4.6)         | Highest judgment, ambiguity handling        |
| Execution  | **Copilot (default)** | Best request efficiency for deterministic work |
| Validation | Claude (claude-sonnet-4.6)       | Thor must be independent of executor        |
...
| `claude-claude-sonnet-4.6`  | Paid API | Anthropic billing, not Copilot free tier |
...
| ---------------------- | -------- | ----------------------------------------------------------- |
| **Standard**           | `claude-sonnet-4.6` | Clear requirements, known patterns, 1-3 files               |
| **Requires reasoning** | `claude-opus-4.6`   | Ambiguous, architectural, cross-cutting, unknown root cause |
