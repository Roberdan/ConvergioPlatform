...
export const KANBAN_MISSION = {
  plans: [
    ...
    {
      plan: { id: 303, name: 'Hotfix auth', status: 'doing', tasks_done: 2, tasks_total: 3, human_summary: null, execution_host: '', execution_peer: 'mac-worker-2', parallel_mode: null, project_id: 'proj-1', project_name: 'VirtualBPM', project_path: '/tmp' },
