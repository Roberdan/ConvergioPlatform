(function () {
  ...
  function ensureRoot() {
    ...
    root.innerHTML = `
      ...
      <button id="chat-project-new" class="mn-widget__action repo-selector-btn" type="button">New Project</button>
      <dialog id="chat-new-project-modal" class="repo-modal">
        <form id="chat-new-project-form" method="dialog" class="repo-modal-form">
          ...
          <div class="repo-modal-actions">
            <button id="repo-create-confirm" class="mn-widget__action" type="submit">Create</button>
            <button id="repo-create-cancel" class="mn-widget__action" type="button">Cancel</button>
          </div>
