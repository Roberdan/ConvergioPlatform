...
get_route_case!(
    has_coordinator_status,
    shape_coordinator_status,
    "/api/coordinator/status"
);
get_route_case!(
    has_coordinator_toggle,
    shape_coordinator_toggle,
    "/api/coordinator/toggle"
);
get_route_case!(has_peers, shape_peers, "/api/peers");
get_route_case!(
    has_peers_discover,
    shape_peers_discover,
    "/api/peers/discover"
);
