// TuiApp render helpers — extracted to keep app.rs under 250 lines.

use std::io;

use crate::tui::data::MainView;
...
impl TuiApp {
    ...
    pub(crate) fn view_index(v: MainView) -> usize {
        use MainView::*;
    ...
    pub(crate) fn view_at(idx: usize) -> MainView {
        use MainView::*;
        [PlanKanban, TaskPipeline, MeshStatus, AgentOrgChart, BrainCanvas,
         CostCenter, EventStream, WorkspaceView, Deliverables, Chat]
