...
use super::{
    api_a2ui, api_agent_catalog, api_agent_control, api_agent_history, api_agent_profiles,
    api_agent_triage, api_agents,
    ...
    api_kernel_audio, api_memory, api_memory_mgmt, api_mesh, api_mesh_plan_closed, api_mesh_register, api_mesh_update, api_metrics,
...
pub fn build_router_with_state(static_dir: PathBuf, state: ServerState) -> Router {
    ...
    Router::new()
        ...
        .merge(api_mesh_plan_closed::router())
        ...
        .merge(api_a2ui::router(state.clone()))
