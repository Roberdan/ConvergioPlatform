...
pub fn router() -> Router<ServerState> {
    Router::new()
        ...
        .route(
            ...
            get(plans::api_tasks_distribution),
        )
        ...
        .route(
            ...
            post(nightly::api_nightly_job_trigger),
        )
        .route(
        ...
        .route(
            ...
            post(nightly::api_nightly_job_create),
        )
        .route(
            "/api/nightly/jobs/:id/retry",
            post(nightly::api_nightly_job_retry),
        )
        .route(
            "/api/nightly/jobs/:id",
            get(nightly::api_nightly_job_detail),
        )
        .route(
        ...
        .route(
            "/api/projects",
            get(plans::api_projects).post(plans::api_project_create),
        )
        .route("/api/events", get(nightly::api_events))
        .route(
            "/api/coordinator/status",
            get(nightly::api_coordinator_status),
        )
        .route(
            "/api/coordinator/toggle",
            get(nightly::api_coordinator_toggle),
        )
