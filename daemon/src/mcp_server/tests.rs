...
mod tests {
    ...
    fn list_tools_ring0_returns_all_tools() {
        ...
        assert_eq!(tools.len(), 43, "Ring 0 must expose all 43 tools, got {}", tools.len());
    }
    ...
    fn list_tools_ring1_returns_16_tools() {
        ...
        assert_eq!(tools.len(), 41, "Ring 1 must expose 41 tools, got {}", tools.len());
    ...
    fn handle_tools_list_returns_tools_array() {
        ...
        assert_eq!(arr.len(), 41, "ring 1 must see 41 tools (restart_node+assign_role are ring-0)");
    }
