//! Repo analysis engine — scans a local repository and produces a structured
//! profile covering languages, frameworks, CI, dependencies, and structure.
...
///
/// Walks the filesystem (no git operations) to detect languages, frameworks,
/// CI configuration, dependencies, and structural indicators. For speed,
/// line counting is capped at 1000 files.
pub fn scan_repo(path: &Path) -> Result<RepoProfile, String> {
    ...
    // Check root and immediate subdirectories for manifest files.
